...
export default function SignUpPage() {
  ...
  const { signup, error: authError, isLoading: authLoading } = useAuthStore()
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Use authStore signup (calls NestJS backend + auto-saves token)
      await signup(formData.email, formData.password, formData.name, formData.role)

      // Success! Auth store automatically saves user + token
      ...
      // Error is already set in authStore, but we can also set local error
