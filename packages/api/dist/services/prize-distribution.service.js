...
export class PrizeDistributionService {
     ...
     */
    static async createAnswerProof(studentComputer, params) {
        try {
     ...
     */
    static async createPrizePayment(teacherComputer, params) {
        try {
     ...
     */
    static async preparePrizeSwap(teacherComputer, params) {
        try {
            ...
            const { tx: partialSwapTx } = await swapHelper.createPrizeSwapTx(prizePayment, answerProof, syncedAttempt, SIGHASH_SINGLE | SIGHASH_ANYONECANPAY);
            return {
                success: true,
     ...
     */
    static async completePrizeSwap(studentComputer, params) {
        try {
     ...
     */
    static async claimPrize(studentComputer, params) {
        try {
...
//# sourceMappingURL=prize-distribution.service.js.map