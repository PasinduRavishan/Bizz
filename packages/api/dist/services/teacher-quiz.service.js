...
export class TeacherQuizService {
     ...
     */
    static async createQuiz(teacherComputer, params) {
        try {
            const { teacherId, symbol, questionHashIPFS, correctAnswers, prizePool, entryFee, passThreshold, deadline, title, description } = params;
            ...
            const answerHashes = correctAnswers.map((answer, index) => QuizCrypto.hashAnswer(tempQuizId, index, answer, salt));
            // Calculate deadlines
...
//# sourceMappingURL=teacher-quiz.service.js.map